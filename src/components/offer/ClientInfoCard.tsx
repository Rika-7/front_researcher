    ...
    <div className="relative w-full text-black rounded min-h-[64px]">
      <div className="z-0 flex-1 w-full bg-white rounded">
        <div className="flex flex-1 gap-1 items-start py-1 pl-4 rounded size-full">
          <div className="flex flex-col flex-1 shrink justify-center py-1 basis-0 min-h-10">
            <label className="flex-1 shrink self-stretch text-xs tracking-wide leading-none">
              {label}
            </label>
            <div className="flex-1 shrink self-stretch w-full text-sm tracking-wide">
              {value}
            </div>
          </div>
...
export const ClientInfoCard: React.FC = () => {
  return (
    <div className="w-[21%] max-md:ml-0 max-md:w-full">
      <article className="flex flex-col px-4 py-8 w-full bg-white rounded-2xl shadow-[0px_0px_15px_rgba(0,0,0,0.03),0px_2px_30px_rgba(0,0,0,0.08),0px_0px_1px_rgba(0,0,0,0.30)] h-[580px]">
